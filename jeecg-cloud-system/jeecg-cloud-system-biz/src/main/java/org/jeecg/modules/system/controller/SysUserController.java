...
//                json.put("avatar", item.getSysUser().getAvatar());
     ...
     * @return
     */
    @GetMapping(value = "queryUserDataRule")
    public List<SysPermissionDataRule> queryUserDataRule(@RequestParam(name="username") String username,
                                                         @RequestParam(name="permissionId") String permissionId){
        return sysPermissionDataRuleService.queryPermissionDataRules(username, permissionId);
    }
